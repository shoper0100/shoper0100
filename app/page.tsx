    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center">
      ...
      <div className="text-center max-w-4xl mx-auto mb-16">
        <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
          Welcome to <span className="text-blue-500">RideBNB</span>
        </h1>
        <p className="text-xl text-gray-400 mb-8">
          A decentralized matrix platform on opBNB network with multi-level income distribution and royalty rewards
        </p>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          ...
          <h3 className="text-white text-xl font-bold mb-2">Binary Matrix</h3>
          <p className="text-gray-400">
            Automated binary tree placement with fair distribution across all participants
          </p>
        </div>
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          ...
          <h3 className="text-white text-xl font-bold mb-2">13 Levels</h3>
          <p className="text-gray-400">
            Progressive level system with increasing rewards and benefits at each stage
          </p>
        </div>
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          ...
          <h3 className="text-white text-xl font-bold mb-2">Royalty Rewards</h3>
          <p className="text-gray-400">
            4-tier royalty system for top performers with daily distribution pools
          </p>
        </div>
      </div>
