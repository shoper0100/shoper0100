...
async function main() {
    console.log("🚀 Deploying FiveDollarRideRoyalty to BSC Testnet...\n");
    ...
    if (!USDT_ADDRESS) {
        throw new Error("❌ USDT_BSC_TESTNET not set in .env file!");
    }
    ...
    console.log("2. Add to .env: FIVEDOLLARRIDE_ROYALTY_BSC_TESTNET=" + royaltyAddress);
    console.log("3. Run: node scripts/deploy_fivedollarride_bsc_testnet.cjs");
    console.log("4. Then: node scripts/connect_contracts_bsc_testnet.cjs");
}
