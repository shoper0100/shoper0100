...
async function main() {
    console.log("🚀 Deploying FiveDollarRideRoyalty to opBNB Mainnet...\n");
    ...
    if (!USDT_ADDRESS) {
        throw new Error("❌ USDT_OPBNB_MAINNET not set in .env file!");
    }
    ...
    console.log("2. Add to .env: FIVEDOLLARRIDE_ROYALTY_MAINNET=" + royaltyAddress);
    console.log("3. Run: node scripts/deploy_ridebnb_mainnet.js");
    console.log("4. Then: node scripts/connect_contracts_mainnet.js");
}
