                            ...
                            <>
                                ...
                                {activeTab === 'team' && userInfo && (
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-700 rounded-xl p-4 md:p-6 shadow-2xl border-2 border-yellow-400/30">
                                        ...
                                        <div className="mb-4">
                                            <h3 className="text-white font-bold mb-3 text-sm">Binary Matrix - All 13 Levels</h3>
                                            <div className="bg-black/30 rounded-xl p-3 overflow-x-auto">
                                                <div className="min-w-[700px]">
                                                    {Array.from({ length: 13 }, (_, levelIdx) => {
                                                        ...
                                                        // Show filled only if user has team members (you can adjust this logic based on actual team data)
                                                        const totalTeam = userInfo.team || 0;
                                                        const isFilled = totalTeam > 0 && level <= Math.ceil(Math.log2(totalTeam + 1));
                                                            ...
                                                            <div key={level} className="mb-1.5">
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <span className="text-gray-400 text-xs w-24 text-right">
                                                                        {nodesInLevel.toLocaleString()} {isFilled ? '✓' : 'vacant'}
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        );
